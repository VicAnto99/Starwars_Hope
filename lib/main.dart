      ...
      home: Scaffold(
        body: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              creaTecla(color: Colors.black , nota: 1),
              creaTecla(color: Colors.blueGrey , nota: 2),
              creaTecla(color: Colors.blue , nota: 3),
              creaTecla(color: Colors.green , nota: 4),
              creaTecla(color: Colors.yellow , nota: 5),
              creaTecla(color: Colors.red, nota: 6),
              creaTecla(color: Colors.white , nota: 7),
              creaTecla(color: Colors.purple , nota: 8),
              creaTecla(color: Colors.pink , nota: 9),
              creaTecla(color: Colors.orange , nota: 10),
            ],
          ),
        ),
      ),
